...
<div id="inicio" class="hero">
  ...
  <div class="container hero-content">
    ...
    <p class="hero-intro">
      ...
      una arquitectura productiva en BigQuery + dbt.
    </p>
    <div class="hero-faq">
      <div class="faq-card">
        <h3>Objetivo</h3>
      ...
      <div class="step-card">
        ...
        <div class="step-card-body">
          ...
          <p>La solución local funciona con pandas y una laptop. Productivizarla requiere
             BigQuery + dbt + Airflow para procesar 5,000M de filas diarias sin reproducir el costo.</p>
        </div>
      </div>
    </div>
    ...
    <div class="datasec-block">
      ...
      <div class="datasec-steps">
        <div class="ds-step"><div class="ds-num">V1</div>
          <div class="ds-step-body">
            <h4>Baseline — StandardScaler sobre avg_price bruto</h4>
            <p>Resultado: silhouette = 0.62 (inflado artificialmente).
               El cluster 3 tenía avg_price = $546,640 MXN —
               era un artefacto de la imputación contaminada, no un segmento real.
               Los 0.62 eran la separación entre datos reales y datos erróneos.</p>
            <span class="dc-pill red">Descartado — métricas engañosas</span>
          </div>
        </div>
        <div class="ds-step"><div class="ds-num">V2</div>
          <div class="ds-step-body">
            <h4>Opción A (sugerencia inicial del modelo de IA) — log + StandardScaler</h4>
            <p>Corrección: log1p sobre precios. Resultado: clusters más interpretables.
               Pero el cluster 3 seguía siendo un artefacto — la imputación se hacía
               ANTES de eliminar outliers, propagando $500M a ítems nulos de la misma categoría.</p>
            <span class="dc-pill">Parcialmente correcto — problema de orden</span>
          </div>
        </div>
        <div class="ds-step"><div class="ds-num">V2b</div>
          <div class="ds-step-body">
            <h4>Opción B (propuesta alternativa) — RobustScaler + remoción p99</h4>
            <p>Se propuso usar p99 ($29,999 MXN) como umbral y RobustScaler.
               Resultado: 99.51% de sellers en un solo cluster.
               <strong>Diagnóstico:</strong> p99 eliminó electrónica premium,
               dejando un dataset tan homogéneo que K-Means no encontraba separación.</p>
            <span class="dc-pill red">Descartado — blob del 99.51%</span>
          </div>
        </div>
        <div class="ds-step"><div class="ds-num">V3</div>
          <div class="ds-step-body">
            <h4>Pipeline Final — Orden correcto + RobustScaler + pct_ds</h4>
            <p>Fix: <strong>(1)</strong> eliminar precios > $1M con umbral de dominio,
               <strong>(2)</strong> imputar (ahora sin contaminación),
               <strong>(3)</strong> log1p,
               <strong>(4)</strong> RobustScaler (mediana+IQR, más robusto que StandardScaler sin winsorizaciones).
               Bonus: agregado <code>pct_ds</code> que permitió separar Drop Shippers como segmento propio.</p>
...
<section class="section" id="bigquery">
  <div class="container">
    ...
    <h2>Escalabilidad en <span>BigQuery + dbt</span></h2>
    ...
    <div class="decision-grid">
      ...
      <div class="decision-card">
        ...
        <ul>
          <li>Sin dbt: 2.5 TB/día = $625/día</li>
          <li>Con dbt incremental: 6.85 GB/día = $1.70/día</li>
    ...
    <div class="highlight">
      <strong>Modelo dbt incremental:</strong> <code>insert_overwrite</code> sobre la partición
      del mes actual. La primera vez procesa toda la historia; las veces siguientes, solo el
      snapshot nuevo del día (6.85 GB en lugar de 2.5 TB). El flag <code>is_incremental()</code>
      activa automáticamente el filtro por <code>snapshot_date</code>.
    </div>
  </div>
</section>
<div class="container"><div class="divider"></div></div>
...
<!-- 09 GENAI -->
<section class="section" id="genai">
  <div class="container">
    <div class="section-label">09 — Integración GenAI</div>
    <h2>IA como capa <span>interpretativa</span>, no como clasificador</h2>

    <div class="hero-faq" style="margin-bottom:24px;">
      <div class="faq-card">
        <h3>❌ Lo que se descartó</h3>
        <p>Clustering sobre embeddings de títulos de publicaciones.
           Los embeddings agrupan por similitud semántica del texto — produce clusters
           de <em>categorías de producto</em>, no de <em>perfiles de negocio</em>.</p>
      </div>
      <div class="faq-card">
        <h3>✅ Lo que se implementó</h3>
        <p>K-Means numérico para los clusters + Claude/LLM para interpretar los
           centroides en lenguaje de negocio: etiquetas, estrategias y riesgo de churn
           por segmento.</p>
      </div>
    </div>

    <div class="highlight green">
      <strong>Por qué este enfoque es superior:</strong> los clusters están anclados en datos
      reales (no en intuición del LLM). Las estrategias son contextualizadas al perfil numérico,
      no genéricas. Es reproducible: mismos centroides = mismo prompt = salida consistente.
    </div>
  </div>
</section>
<div class="container"><div class="divider"></div></div>
...
<section class="section" id="proximos">
  <div class="container">
    <div class="section-label">10 — Próximos Pasos</div>
    ...
    <div class="step-cards">
      ...
      <div class="step-card">
        <div class="step-num">3</div>
        <div class="step-card-body">
          <h4>PCA antes del clustering</h4>
          <p>Los canales logísticos (pct_fbm, pct_xd, pct_ds) están correlacionados
             ...
             1-2 componentes, dando a K-Means un espacio de features más ortogonal.</p>
        </div>
      </div>
      <div class="step-card">
        <div class="step-num">4</div>
        <div class="step-card-body">
          <h4>Deploy del pipeline en Vertex AI + Airflow</h4>
          <p>Mover el modelo K-Means a Vertex AI Pipelines para re-entrenamiento mensual
             automático. Orquestar con Airflow DAG: ingest → dbt → train → score → notify AM.</p>
        </div>
      </div>
    </div>
  </div>
